...
<!-- Left Side -->
  <div class="col-md-6">
    <div class="category-1 text-center">
      ...
      <p><em>Logo/Intro Animation | Commercial</em></p>
      <iframe src="//fast.wistia.net/embed/playlists/zl5tr460h0?media_0_0%5BautoPlay%5D=false&media_0_0%5BcontrolsVisibleOnLoad%5D=true&plugin%5Bsocialbar-v1%5D%5Bbuttons%5D=twitter-linkedIn-facebook&theme=tab&version=v1&videoOptions%5BautoPlay%5D=true&videoOptions%5BplayerColor%5D=6da2a3&videoOptions%5BvideoHeight%5D=248&videoOptions%5BvideoWidth%5D=440&videoOptions%5BvolumeControl%5D=true" allowtransparency="true" frameborder="0" scrolling="no" class="wistia_playlist" name="wistia_playlist" allowfullscreen mozallowfullscreen webkitallowfullscreen oallowfullscreen msallowfullscreen width="440" height="248"></iframe>
    </div>

    <div class="category-2 text-center">
      <h3>Workflow</h3>
      <p><em>Screencasts of Projects</em></p>
...
<!-- Left Side -->
  <div class="col-md-6">
    <div class="category-3 text-center">
      <h3>iPhone Jams</h3>
      <p><em>Travel/Lifestyle videos</em></p>
    ...
    <div class="category-4 text-center">
      <h3>Insta Edits</h3>
      <p><em>Instagram videos/animations</em></p>
